    ...
    public SecurityFilterChain filterChain (HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .antMatchers(HttpMethod.POST,"/*/boards/*/replies").hasRole("ADMIN")
                        .antMatchers(HttpMethod.GET,"/*/boards/*/replies/**").hasRole("ADMIN")
                        .antMatchers(HttpMethod.PATCH,"/*/boards/*/replies/**").hasRole("ADMIN")
                        .antMatchers(HttpMethod.DELETE,"/*/boards/*/replies/**").hasRole("ADMIN")
                        .antMatchers(HttpMethod.POST,"/*/boards/*/like").hasAnyRole("ADMIN","USER")
